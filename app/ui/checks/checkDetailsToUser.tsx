  ...
  return (
    <>
      <main className="flex flex-col gap-2">
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="h-full w-full flex flex-col gap-2">
          <div className="will-change-transform flex flex-col gap-2 mb-2">
