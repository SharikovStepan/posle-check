...
export default function GroupCard({ groupData }: { groupData: GroupCardType }) {
  ...
  return (
    <>
      <Link href={`/groups/${groupData.id}`} className="block hover:border-border-focus border border-transparent cursor-pointer transition-all duration-200 focus rounded-2xl">
